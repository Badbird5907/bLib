...
//		WARNING: Modifying this code will get your plugin banned on bStats. Just don't do it!
		long initialDelay = (long) (60000 * (3 + (Math.random() * 3)));
		long secondDelay = (long) (60000 * (Math.random() * 30));
...
//			null = skip the chart
	...
	public static class DrilldownPie extends CustomChart {
		...
		public JsonObject getChartData() throws Exception {
			...
			if ((map == null) || map.isEmpty()) return null; // Null = skip the chart
			...
			if (reallyAllSkipped) return null; // Null = skip the chart
			data.add("values", values);
			return data;
		}
	}
